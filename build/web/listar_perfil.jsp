                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h3><strong class="card-title">Lista dos Perfis de usuário</strong></h3>
                            </div>
                            <div class="card-body">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered" id="listaPerfil">
                                   ...
                                   <c:forEach var="p" items="${perfil.lista}">
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-outline-secondary btn-sm" href="gerenciar_menu_perfil.do?acao=gerenciar&idperfil=${p.idperfil}">
                                             <i class="fa fa-warning">Pemissões</i>
                                            </a>    
                                        </td>
                                    </tr>
                                   </c:forEach>
