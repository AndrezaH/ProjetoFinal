                            ...
                            <div class="card-body">
                                ...
                                Parcelamento p = new Parcelamento();
                                    try{
                                        ...
                                        if(acao.equals("novo")){
                                            int iorcamento = Integer.parseInt(request.getParameter("idorcamento"));
                                            o = c.getCarregaPorID(idorcamento);
                                            p.setOcamento(o);
                                            p.setParcela(new ArrayList<Parcela>());
                                            session.setAttribute("parcelamento", p);
                                        }else{
                                            p = (parcelamento) session.getAttribute("parcelamento");
                                        }
                                    }catch(Exception e){
                                        out.print("Erro:"+e);
                                    }
                              ...
                              <c:forEach var="p" items="${produto.lista}">   
                                ...
                                <form action="gerenciar_carrinho.do" method="get">
                                    <input type="hidden" name="idproduto" value="${p.idproduto}"/>
                                        ...
                                        ${p.nome}
                                        <input type="number" value="1" name="qtd" style="width: 40px;"/>
                                        <button class="btn btn-default"><img src="imagens/carrinho.png" width="30px" height="30px"/></button>
                                </form>
