                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h3><strong class="card-title">Cadastrar um novo pagamento</strong></h3>
                            </div>
                            <div class="card-body">
                                <!--<table id="bootstrap-data-table-export" class="table table-striped table-bordered">-->
                                    <form name="form_pagamento.jsp" action="gerenciar_pagamento.do" method="POST">
                                       <div class="row">
                                           <div class="form-group col-sm-8">
                                               <input type="hidden" name="idpagamento" id="idpagamento"
                                                      class="form-control" value="${pagamento.idpagamento}"/>
                                               <label for="valor" class="control-label">
                                                   Valor
                                               </label>
                                               <input type="text" name="valor" id="valor"
                                                      class="form-control" required=""
                                                      value="<fmt:formatNumber pattern="#,##0.00" value="${pagamento.valor}"/>"/>
                                           </div>
                                       </div>
                                       <div class="row">
                                           <div class="form-group col-sm-8">
                                               ...
                                               <input type="text" name="data" id="data"
                                                      class="form-control" required=""
                                                      value="<fmt:formatDate pattern="dd/MM/yyyy" value="${pagamento.data}"/>"/>
                                           </div>
                                       </div>
                                       <div class="row">
                                           <div class="form-group col-sm-8">
                                               ...
                                               <select id="idfuncionario" name="idfuncionario" required="" class="form-control">
                                                   ...
                                                   <c:forEach var="f" items="${funcionario.lista}">
                                                       <option value="${f.idfuncionario}"
                                                               <c:if test="${f.idfuncionario==pagamento.funcionario.idfuncionario}">
                                                                   selected=""
                                                               </c:if>        
                                                       >${f.nome}</option>
                                                   </c:forEach>
                                       ...
                                       <div class="row">
                                           ...
                                           <a href="listar_pagamento.jsp" class="btn btn-warning">
                                               Voltar
                                           </a>    
                                       </div>
                                   </form>
