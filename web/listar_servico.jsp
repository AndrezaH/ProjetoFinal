                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h3><strong class="card-title">Lista dos Serviços</strong></h3>
                                        
                            <div class="card-body">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered" id="listaServico">
                                    <a href="form_servico.jsp" class="btn btn-primary">Novo Cadastro</a>
                                     <thead>
                                         <tr>
                                       <th>ID</th>
                                       <th>Descrição</th>
                                   ...
                                   <c:forEach var="s" items="${servico.lista}">
                                    <tr>
                                        <td>${s.idservico}</td>
                                        <td>${s.descricao}</td>
                                        <td>${s.tipo_servico.tipo_servico}</td>
                                        <td>
                                            <a class="btn btn-primary" href="gerenciar_servico.do?acao=alterar&idservico=${s.idservico}">
                                             <i class="fa fa-pencil"></i>
                                            </a>
                                            <button class="btn btn-danger" onclick="confirmarExclusao(${s.idservico},'${s.idservico}')">
                                                <i class="fa fa-trash-o"></i>
                                            </button>
                                           <!-- <button type="button" class="btn btn-outline-link" href="gerenciar_servico_orcamento.do?acao=gerenciar&idservico=${s.idservico}">
                                             Acessos
                                            </button>  -->  
                                        </td>
                                    </tr>
