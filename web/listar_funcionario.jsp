...
<script type="text/javascript">
            function confirmarExclusao(id, nome){
                if(confirm('Deseja realmente excluir o funcionario '+nome+'?')){
                  location.href='gerenciar_funcionario.do?acao=excluir&idfuncionario='+id;
                }
            }
        </script> 
</head>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h3><strong class="card-title">Lista de Funcionários</strong></h3>
                            </div>
                            <div class="card-body">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered" id="listaFuncionario">
                                   <a href="form_funcionario.jsp" class="btn btn-primary">Novo Cadastro</a>
                                    ...
                                    <tbody>
                                        <c:forEach var="f" items="${funcionario.lista}">
                                            ...
                                            <td>
                                             <a class="btn btn-primary" href="gerenciar_funcionario.do?acao=alterar&idfuncionario=${f.idfuncionario}">
